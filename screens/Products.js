...
import { Text, View, StyleSheet, Dimensions, Button, Alert, SafeAreaView, Image, TouchableOpacity } from "react-native";
        ...
        if (count > 0) {
             data = searchResult.map((result, index)=>{
                ...
                return (
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate("ViewProduct", { imageURI:`${API}/${IMG}/${result.image}` })} >
